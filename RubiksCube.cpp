...
bool rubiksCube:: checkTheRubiksCubeAfterSolution( void ) {
    if (   holderLowerSide[r1][c1] == holderLowerSide[r2][c2]
        && holderLowerSide[r2][c1] == holderLowerSide[r2][c2]
...
bool rubiksCube:: solutionAlgorithmForRubiksCube( void ) {
    bool control = false ;
    int sum = 0 ;
    
    control = checkTheRubiksCubeAfterSolution() ;
    if ( control == false ) {
        sum = sum + solutionAlgorithmForPlusSignOnLowerSide() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
        sum = sum + solutionAlgorithmOfLowerCorner() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
        sum = sum + solutionAlgorithmOfSecondLayer() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
        sum = sum + solutionAlgorithmForPlusSignOnUpperSide() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
        sum = sum + solutionAlgorithmForCompletedOnUpperSide() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
        sum = sum + solutionAlgorithmOfUpperSidesEdges() ;
        systemPause() ;
        displayRubiksCube() ;
        systemPause() ;
    }
    ...
    cout << endl << "Number of successful process: " << sum << endl ;
